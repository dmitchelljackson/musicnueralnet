...
public class WavFile
{
	...
	// Cannot instantiate wav.WavFile directly, must either use newWavFile() or openWavFile()
	private WavFile()
	{
...
//		}
	...
	{
		if (ioState != IOState.READING) throw new IOException("Cannot read from wav.WavFile instance");
	...
	{
		if (ioState != IOState.WRITING) throw new IOException("Cannot write to wav.WavFile instance");
